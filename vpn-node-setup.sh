...
#  ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝     ╚═╝ ╚═════╝ ╚═════╝ 
#                                                         
#  XRAY/REMNAWAVE NODE BUILDER v5.0.1 (UNIVERSAL: оптимизация + диагностика)
...
case "$MODE" in
    diagnose)
        ...
        if [ $diag_rc -eq 0 ]; then
            ...
            # v5.0 BUGFIX: $0 при `bash <(curl ...)` равен /dev/fd/63 — не путай юзера.
            DIAG_SELF_PATH=$(v5_self_invocation)
            echo -e "  ${CYAN}sudo bash $DIAG_SELF_PATH --optimize${NC}"
            echo ""
...
echo "  ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝     ╚═╝ ╚═════╝ ╚═════╝ "
echo -e "${NC}"
echo -e "${BOLD}  XRAY/REMNAWAVE NODE BUILDER v5.0.1 (Universal: Optimize + Diagnose)${NC}"
