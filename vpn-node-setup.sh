...
#  ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝     ╚═╝ ╚═════╝ ╚═════╝ 
#                                                         
#  XRAY/REMNAWAVE NODE BUILDER v5.3.2 (XanMod codename guard + tuning corrections)
...
echo "  ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝     ╚═╝ ╚═════╝ ╚═════╝ "
echo -e "${NC}"
echo -e "${BOLD}  XRAY/REMNAWAVE NODE BUILDER v5.3.2 (Universal: Optimize + Diagnose)${NC}"
...
if [ "${SETUP_DISABLE_UNATTENDED:-1}" = "1" ]; then
    ...
    print_warn "unattended-upgrades будет отключён → НЕТ авто-секьюрити-апдейтов (включая ядро)."
